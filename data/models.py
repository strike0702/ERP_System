...
class Class(models.Model):
    ...
    def __str__(self):
        ...
        return f"{d.name} : {self.sem}_{self.section}"
...
class Assign(models.Model):
    ...
    def __str__(self):
        cl = Class.objects.get(id=self.class_id.id)
...
class Attendance(models.Model):
    ...
    def __str__(self):
        ...
        return f"{sname.name} : {cname.shortname}"
...
class Marks(models.Model):
    ...
    def total_marks(self):
        if self.name == 'End Semester Exam':
            return 100
        elif self.name == 'Mid Semester Exam':
            return 50
        return 20
        ...
        if hasattr(instance, 'name'):
            ...
            for assign in assign_list:
                try:
                    ...
                    sc = StudentCourse(student=instance, course=assign.course)
                    sc.save()
...
@receiver(post_delete,sender=Assign)
