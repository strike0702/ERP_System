...
class StudentCourseAdmin(admin.ModelAdmin):
    ...
    ordering = ('student__class_id__dept__name', 'student__class_id__id', 'student__roll_no')

admin.site.register(StudentCourse, StudentCourseAdmin)

class StudentAdmin(admin.ModelAdmin):
    list_display = ('roll_no', 'name', 'class_id')
    search_fields = ('roll_no', 'name', 'class_id__id', 'class_id__dept__name')
    ordering = ['class_id__dept__name', 'class_id__id', 'roll_no']
